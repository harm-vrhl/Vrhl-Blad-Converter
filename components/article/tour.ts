...
function stappen(scherm: "start" | "artikel" | "magazine"): DriveStep[] {
  if (scherm === "artikel") return aanwezig(artikel);
...
function plek(id: string, title: string, description: string, side?: Side): DriveStep {
  return {
